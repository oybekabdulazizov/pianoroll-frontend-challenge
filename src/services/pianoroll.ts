...
export default class PianoRoll {
  ...
  private note_height: number | undefined;
  private backgroundColormap: string[] = [];
  private noteColormap: string[] = [];

  constructor(svgElement: SVGSVGElement, sequence: Array<IData>) {
    this.svgElement = svgElement as any as SVGSVGElement;
    this.end = null;
  ...
  drawPianoRoll(sequence: Array<IData>) {
